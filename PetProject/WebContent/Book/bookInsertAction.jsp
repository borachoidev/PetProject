...
<%
	...
	response.sendRedirect("../index.jsp?main=Book/bookInfo.jsp?petcenter="+petcenter+"&startday="+startday+"&petselect="+petselect+"&user_name="+user_name+"&hp="+hp+"&dog_name="+dog_name);
