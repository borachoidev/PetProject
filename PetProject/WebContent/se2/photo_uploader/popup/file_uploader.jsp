...
//String path = request.getSession().getServletContext().getRealPath("/") + File.separator + "save"; // 이미지가 저장될 주소
String path = request.getSession().getServletContext().getRealPath("/") + "save2";
String filename = "";
